...
from clocwork.sources import antigravity, claude_code, codex, copilot, gemini, kilo, opencode, qwen

SOURCES = (claude_code, codex, copilot, gemini, kilo, opencode, qwen, antigravity)
