...
['opencode', 'copilot', 'kilo', 'qwen', 'antigravity'].forEach(key => {
...
check(known.length === 8 && known.indexOf(future) < 0, 'and it is no known source\'s (' + future + ' against ' + known.join(' ') + ')');
check(withCodex.run('return SOURCE_COLOURS["antigravity"]') === 'magenta-2', 'Antigravity keeps its own shade, magenta-2');
