...
<!-- To regenerate: run clocwork on this repository, re-render the workspace
with `--locale en-GB`, capture index.html with headless Chrome
(`--window-size=1200,1300 --force-device-scale-factor=2
--virtual-time-budget=15000 --screenshot`), crop just below the Code Lines
Over Time card, and quantise to 256 colours. -->
